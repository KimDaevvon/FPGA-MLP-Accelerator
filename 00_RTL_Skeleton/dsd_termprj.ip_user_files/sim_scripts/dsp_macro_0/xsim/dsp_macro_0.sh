...
#
# Script generated by Vivado on Sun Jun 15 09:35:08 +0900 2025
...
simulate()
{
  xsim dsp_macro_0 -key {Behavioral:sim_1:Functional:dsp_macro_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
